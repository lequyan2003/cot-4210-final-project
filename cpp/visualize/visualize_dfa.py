...
def draw_dfa_from_json(json_file: str, output_file: str = "dfa_visual"):
    ...
    print(f"[OK] Rendered DFA to: {output_file}.png")

if __name__ == "__main__":
    draw_dfa_from_json("output/dfa.json", output_file="visualize/dfa_visual")
